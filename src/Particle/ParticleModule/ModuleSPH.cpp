...
#include "Particle/PaticleEmitter/ParticleEmitterPoint.hpp" // suppr
...
*/
    ...
    dynamic_cast<ParticleEmitterPoint &>(emitter_).supprMe(cpuBufferModuleParam_.smoothingRadius);
