...
__kernel void ResolvePhysicSpawn(__global ParticleDataPhysic *dataPhysic,
                                 __global int *arrayParticleSpawned) {
    uint id = get_global_id(0);
    __global ParticleDataPhysic *physic = &dataPhysic[arrayParticleSpawned[id]];
