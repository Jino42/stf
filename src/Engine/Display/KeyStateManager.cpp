...
KeyStateManager::KeyStateManager() {
	if (KeyStateManager::instance_)
		throw std::runtime_error("KeyStateManager:: can be instancied one time");
	KeyStateManager::instance_ = this;
}

KeyStateManager const &KeyStateManager::Get() {
	return *KeyStateManager::instance_;
}
...
KeyStateManager	*KeyStateManager::instance_ = nullptr;